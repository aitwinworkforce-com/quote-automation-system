...
export const quotes = mysqlTable("quotes", {
 ...
 productDescription: text("productDescription"),
  ...
  supplierCurrency: mysqlEnum("supplierCurrency", ["EUR", "USD", "AUD", "NZD", "GBP"]).default("EUR"),
  ...
  supplierDocxKey: varchar("supplierDocxKey", { length: 512 }),
  supplierDocxUrl: varchar("supplierDocxUrl", { length: 1024 }),
  supplierDocxName: varchar("supplierDocxName", { length: 255 }),
  supplierXlsKey: varchar("supplierXlsKey", { length: 512 }),
  supplierXlsUrl: varchar("supplierXlsUrl", { length: 1024 }),
